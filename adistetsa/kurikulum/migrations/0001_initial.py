...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('ID', models.BigAutoField(primary_key=True, serialize=False)),
                ('HARI', models.CharField(choices=[('Senin', 'Senin'), ('Selasa', 'Selasa'), ('Rabu', 'Rabu'), ('Kamis', 'Kamis'), ('Jum`at', 'Jum`at'), ('Sabtu', 'Sabtu'), ('Minggu', 'Minggu')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('TANGGAL_MENGAJAR', models.DateField(default=django.utils.timezone.now)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('NAMA', models.CharField(max_length=255, validators=[utility.custom_function.cek_huruf_besar_awal_kalimat], verbose_name='MATA PELAJARAN')),
            ],
            options={
