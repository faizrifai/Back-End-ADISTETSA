...
class JurnalBelajarResource(resources.ModelResource):
    guru = Field(
        ...
        widget=ForeignKeyWidget(
            apps.get_model("dataprofil", "DataGuru"), "NAMA_LENGKAP"
        ),
    )
...
class AbsensiSiswaResource(resources.ModelResource):
    nama = Field(
        column_name="NIS",
        attribute="NIS",
        widget=ForeignKeyWidget(apps.get_model("dataprofil", "DataSiswa"), "NAMA"),
    )
...
class JadwalMengajarResource(resources.ModelResource):
    ...
    kelas = Field(column_name="KELAS", attribute="KELAS", widget=CharWidget())
    ...
    def before_import_row(self, row, **kwargs):
        ...
        v_guru = cek_error_import(
            apps.get_model("kurikulum", "DataGuru"), row, "GURU", "NAMA_LENGKAP"
        )
