    ...
    def handle(self, *args, **kwargs):
        ...
        for i in range(5):
            TahunAjaran.objects.create(
                TAHUN_AJARAN_AWAL=2018 + i, TAHUN_AJARAN_AKHIR=2019 + i
            )
        ...
        # Ekskul Pramuka
        KatalogEkskul.objects.create(
            NAMA="PRAMUKA", KATEGORI="Wajib", DESKRIPSI="Ekskul wajib untuk semua siswa"
        )
        ...
        poin_pelanggaran = [
            ...
            {
                "POIN": 60,
                "KETERANGAN": "Rambut panjang menutupi telinga untuk laki-laki",
            },
