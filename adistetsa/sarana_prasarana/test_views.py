...
class SaranaPrasaranaTestCase(SetupData):
    ...
    def test_pengajuan_peminjaman_ruangan_disetujui(self):
        ...
        # tambah pengajuan
        self.client.post(reverse('pengajuan_peminjaman_ruangan'), self.pengajuan_ruangan)
    ...
    def test_pengajuan_peminjaman_ruangan_ditolak(self):
        ...
        # tolak pengajuan
        self.client.credentials(HTTP_AUTHORIZATION='Bearer ' + self.admin_token)
        response = self.client.get(reverse('tolak_pengajuan_peminjaman_ruangan', kwargs={'pk': 1}))
    ...
    def test_pengajuan_peminjaman_barang(self):
        ...
        response = self.client.post(reverse('pengajuan_peminjaman_barang'), self.pengajuan_sarana)
    ...
    def test_pengajuan_peminjaman_barang_ditolak(self):
        ...
        # tolak pengajuan
        self.client.credentials(HTTP_AUTHORIZATION='Bearer ' + self.admin_token)
        response = self.client.get(reverse('tolak_pengajuan_peminjaman_barang', kwargs={'pk': 1}))
