...
class PembayaranForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        ...
        instance.BULAN_PEMBAYARAN_DPSM_RUTIN = ", ".join(
            self.cleaned_data["BULAN_PEMBAYARAN_DPSM_RUTIN"]
        )
        instance.BULAN_PEMBAYARAN_BIMBEL = ", ".join(
            self.cleaned_data["BULAN_PEMBAYARAN_BIMBEL"]
        )
