...
def buat_kuitansi(self):
   ...
   # add another cell
   pdf.cell(200, 7, txt = str('NAMA SISWA    : ' + self.NAMA_SISWA.NIS.NAMA),
            ln = 2, align = 'L')
   pdf.cell(200, 7, txt = str('KELAS                 : ' + str(self.NAMA_SISWA.KELAS)),
            ln = 2, align = 'L')
   pdf.cell(200, 7, txt = str('NOMOR INDUK : ' + str(self.NAMA_SISWA.NIS.NIS)),
            ln = 2, align = 'L')
   pdf.cell(200, 7, txt = 'JENIS PEMBAYARAN :',
            ln = 2, align = 'L')
   pdf.set_font("Times", size = 12)
   pdf.set_xy(10, 0)
   # pdf.ln(1)
