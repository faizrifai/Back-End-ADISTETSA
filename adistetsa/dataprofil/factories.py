...
class DataSiswaFactory(DjangoModelFactory):
    ...
    JENIS_KELAMIN = factory.Faker(
        "random_element", elements=random_enum(ENUM_JENIS_KELAMIN)
    )
    ...
    JENIS_TINGGAL = factory.Faker(
        "random_element", elements=random_enum(ENUM_JENIS_TINGGAL)
    )
    PENERIMA_KPS = "Tidak"
    PENERIMA_KIP = "Tidak"
    LAYAK_PIP = "Tidak"
...
class DataOrangTuaFactory(DjangoModelFactory):
    ...
    JENJANG_PENDIDIKAN_AYAH = factory.Faker(
        "random_element", elements=random_enum(ENUM_JENJANG_PENDIDIKAN)
    )
    PEKERJAAN_AYAH = factory.Faker("job")
    PENGHASILAN_AYAH = factory.Faker(
        "random_element", elements=random_enum(ENUM_PENGHASILAN)
    )
    NIK_IBU = factory.Faker("credit_card_number")
    NAMA_IBU = factory.Faker("name")
    TAHUN_LAHIR_IBU = factory.Faker("date")
    JENJANG_PENDIDIKAN_IBU = factory.Faker(
        "random_element", elements=random_enum(ENUM_JENJANG_PENDIDIKAN)
    )
    PEKERJAAN_IBU = factory.Faker("job")
    PENGHASILAN_IBU = factory.Faker(
        "random_element", elements=random_enum(ENUM_PENGHASILAN)
    )
    NIK_WALI = factory.Faker("credit_card_number")
    NAMA_WALI = factory.Faker("name")
    TAHUN_LAHIR_WALI = factory.Faker("date")
    JENJANG_PENDIDIKAN_WALI = factory.Faker(
        "random_element", elements=random_enum(ENUM_JENJANG_PENDIDIKAN)
    )
    PEKERJAAN_WALI = factory.Faker("job")
    PENGHASILAN_WALI = factory.Faker(
        "random_element", elements=random_enum(ENUM_PENGHASILAN)
    )
...
class DataGuruFactory(DjangoModelFactory):
    ...
    TEMPAT_LAHIR = factory.Faker("city")
    TANGGAL_LAHIR = factory.Faker("date")
    NAMA_IBU_KANDUNG = factory.LazyAttribute(
        lambda p: "{}".format(p.nama_ibu_kandung.upper())
    )
    ...
    NAMA_WAJIB_PAJAK = factory.LazyAttribute(
        lambda p: "{}".format(p.nama_wajib_pajak.upper())
    )
    KEWARGANEGARAAN = "Indonesia"
    STATUS_KAWIN = factory.Faker(
        "random_element", elements=random_enum(ENUM_STATUS_KAWIN)
    )
    NAMA_PASANGAN = factory.LazyAttribute(
        lambda p: "{}".format(p.nama_pasangan.upper())
    )
    ...
    STATUS_PEGAWAI = factory.Faker(
        "random_element", elements=random_enum(ENUM_STATUS_AKTIF)
    )
