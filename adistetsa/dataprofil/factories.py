...
class DataRiwayatKepangkatanPegawaiFactory(DjangoModelFactory):
    ...
    PANGKAT_GOLONGAN = factory.Faker('pyint', min_value=1, max_value=16)
    NO_SK = factory.Faker('credit_card_number')
    TANGGAL_SK = factory.Faker('pyint', min_value=1, max_value=16)
    PANGKAT_GOLONGAN = factory.Faker('pyint', min_value=1, max_value=16)
    MK_TAHUN = factory.Faker('year')
    MK_BULAN = factory.Faker('year')
...
class DataPegawaiFactory(DjangoModelFactory):
    ...
    LINTANG_1 = factory.Faker('longtitude')
    LINTANG_2 = factory.Faker('longtitude')
    AGAMA = factory.LazyFunction(random_agama)
    ...
    PASANGAN_PNS = factory.Faker('random_element', elements=random_enum(ENUM_STATUS_KAWIN))
    ...
    TMT_PENGANGKATAN = factory.Faker('words')
    LEMBAGA_PENGANGKATAN = factory.Faker('company')
    SK_CPNS = factory.Faker('credit_card_number')
    TMT_CPNS = factory.Faker('words')
    TMT_PNS = factory.Faker('words')
