...
class CreateDataKompetensiCase(SetupData):
    def test_create_data_kompetensi(self):
        response = self.client.post(
            reverse("data_kompetensi_karyawan"), self.data_kompetensi
        )
    ...
    def test_edit_data_kompetensi(self):
        ...
        patch_response = self.client.patch(
            reverse("data_kompetensi_karyawan", kwargs={"pk": 1}), self.data_kompetensi
        )
    ...
    def test_delete_data_kompetensi(self):
        ...
        response = self.client.delete(
            reverse("data_kompetensi_karyawan", kwargs={"pk": 1})
        )
...
class CreateDataAnakCase(SetupData):
    ...
    def test_edit_data_anak(self):
        ...
        # test edit data
        patch_response = self.client.patch(
            reverse("data_karyawan_anak", kwargs={"pk": 1}), self.data_anak
        )
        put_response = self.client.put(
            reverse("data_karyawan_anak", kwargs={"pk": 1}), self.data_anak
        )
...
class CreateDataBeasiswaCase(SetupData):
    def test_create_data_beasiswa(self):
        response = self.client.post(
            reverse("data_karyawan_beasiswa"), self.data_beasiswa
        )
    ...
    def test_edit_data_beasiswa(self):
        ...
        # test edit data
        patch_response = self.client.patch(
            reverse("data_karyawan_beasiswa", kwargs={"pk": 1}), self.data_beasiswa
        )
        put_response = self.client.put(
            reverse("data_karyawan_beasiswa", kwargs={"pk": 1}), self.data_beasiswa
        )
    ...
    def test_delete_data_beasiswa(self):
        ...
        # test delete data
        response = self.client.delete(
            reverse("data_karyawan_beasiswa", kwargs={"pk": 1})
        )
...
class CreateDataBukuCase(SetupData):
    ...
    def test_edit_data_buku(self):
        ...
        # test edit data
        patch_response = self.client.patch(
            reverse("data_karyawan_buku", kwargs={"pk": 1}), self.data_buku
        )
        put_response = self.client.put(
            reverse("data_karyawan_buku", kwargs={"pk": 1}), self.data_buku
        )
...
class CreateDataDiklatCase(SetupData):
    ...
    def test_edit_data_diklat(self):
        ...
        # test edit data
        patch_response = self.client.patch(
            reverse("data_karyawan_diklat", kwargs={"pk": 1}), self.data_diklat
        )
        put_response = self.client.put(
            reverse("data_karyawan_diklat", kwargs={"pk": 1}), self.data_diklat
        )
...
class CreateDataKaryaTulisCase(SetupData):
    def test_create_data_karya_tulis(self):
        response = self.client.post(
            reverse("data_karyawan_karya_tulis"), self.data_karya_tulis
        )
    ...
    def test_edit_data_karya_tulis(self):
        ...
        # test edit data
        patch_response = self.client.patch(
            reverse("data_karyawan_karya_tulis", kwargs={"pk": 1}),
...
class CreatedataKesejahteraanCase(SetupData):
    def test_create_data_karyawan_kesejahteraan(self):
        response = self.client.post(
            reverse("data_karyawan_kesejahteraan"), self.data_kesejahteraan
        )
    ...
    def test_edit_data_karyawan_kesejahteraan(self):
        ...
        # test edit data
        patch_response = self.client.patch(
            reverse("data_karyawan_kesejahteraan", kwargs={"pk": 1}),
...
class CreateDataTunjanganCase(SetupData):
    def test_create_data_tunjangan(self):
        response = self.client.post(
            reverse("data_karyawan_tunjangan"), self.data_tunjangan
        )
    ...
    def test_edit_data_tunjangan(self):
        ...
        # test edit data
        patch_response = self.client.patch(
            reverse("data_karyawan_tunjangan", kwargs={"pk": 1}), self.data_tunjangan
        )
        put_response = self.client.put(
            reverse("data_karyawan_tunjangan", kwargs={"pk": 1}), self.data_tunjangan
        )
    ...
    def test_delete_data_tunjangan(self):
        ...
        # test delete data
        response = self.client.delete(
            reverse("data_karyawan_tunjangan", kwargs={"pk": 1})
        )
...
class CreateDataTugasTambahanCase(SetupData):
    def test_create_data_tugas_tambahan(self):
        response = self.client.post(
            reverse("data_karyawan_tugas_tambahan"), self.data_tugas_tambahan
        )
    ...
    def test_edit_data_tugas_tambahan(self):
        ...
        # test edit data
        patch_response = self.client.patch(
            reverse("data_karyawan_tugas_tambahan", kwargs={"pk": 1}),
...
class CreateDataPenghargaanCase(SetupData):
    def test_create_data_penghargaan(self):
        response = self.client.post(
            reverse("data_karyawan_penghargaan"), self.data_penghargaan
        )
    ...
    def test_edit_data_penghargaan(self):
        ...
        # test edit data
        patch_response = self.client.patch(
            reverse("data_karyawan_penghargaan", kwargs={"pk": 1}),
...
class CreateDataNilaiTesCase(SetupData):
    def test_create_data_nilai_tes(self):
        response = self.client.post(
            reverse("data_karyawan_nilai_tes"), self.data_nilai_tes
        )
    ...
    def test_edit_data_nilai_tes(self):
        ...
        # test edit data
        patch_response = self.client.patch(
            reverse("data_karyawan_nilai_tes", kwargs={"pk": 1}), self.data_nilai_tes
        )
        put_response = self.client.put(
            reverse("data_karyawan_nilai_tes", kwargs={"pk": 1}), self.data_nilai_tes
        )
    ...
    def test_delete_data_nilai_tes(self):
        ...
        # test delete data
        response = self.client.delete(
            reverse("data_karyawan_nilai_tes", kwargs={"pk": 1})
        )
...
class CreateDataRiwayatGajiBerkalaCase(SetupData):
    def test_create_data_riwayat_gaji_berkala(self):
        response = self.client.post(
            reverse("data_karyawan_riwayat_gaji_berkala"),
    ...
    def test_edit_data_riwayat_gaji_berkala(self):
        ...
        # test edit data
        patch_response = self.client.patch(
            reverse("data_karyawan_riwayat_gaji_berkala", kwargs={"pk": 1}),
            self.data_riwayat_gaji_berkala,
        )
        put_response = self.client.put(
            reverse("data_karyawan_riwayat_gaji_berkala", kwargs={"pk": 1}),
...
class CreateDataRiwayatJabatanStrukturalCase(SetupData):
    def test_create_data_riwayat_jabatan_struktural(self):
        response = self.client.post(
            reverse("data_karyawan_riwayat_jabatan_struktural"),
    ...
    def test_edit_data_riwayat_jabatan_struktural(self):
        ...
        # test edit data
        patch_response = self.client.patch(
            reverse("data_karyawan_riwayat_jabatan_struktural", kwargs={"pk": 1}),
            self.data_riwayat_jabatan_struktural,
        )
        put_response = self.client.put(
            reverse("data_karyawan_riwayat_jabatan_struktural", kwargs={"pk": 1}),
...
class CreateDataRiwayatKepangkatanCase(SetupData):
    def test_create_data_karyawan_riwayat_kepangkatan(self):
        response = self.client.post(
            reverse("data_karyawan_riwayat_kepangkatan"), self.data_riwayat_kepangkatan
        )
    ...
    def test_edit_data_karyawan_riwayat_kepangkatan(self):
        ...
        # test edit data
        patch_response = self.client.patch(
            reverse("data_karyawan_riwayat_kepangkatan", kwargs={"pk": 1}),
...
class CreateDataRiwayatPendidikanFormalCase(SetupData):
    def test_create_data_karyawan_riwayat_pendidikan_formal(self):
        response = self.client.post(
            reverse("data_karyawan_riwayat_pendidikan_formal"),
    ...
    def test_edit_data_karyawan_riwayat_pendidikan_formal(self):
        ...
        # test edit data
        patch_response = self.client.patch(
            reverse("data_karyawan_riwayat_pendidikan_formal", kwargs={"pk": 1}),
            self.data_karyawan_riwayat_pendidikan_formal,
        )
        put_response = self.client.put(
            reverse("data_karyawan_riwayat_pendidikan_formal", kwargs={"pk": 1}),
...
class CreateDataRiwayatSertifikasiCase(SetupData):
    def test_create_data_karyawan_riwayat_sertifikasi(self):
        response = self.client.post(
            reverse("data_karyawan_riwayat_sertifikasi"), self.data_riwayat_sertifikasi
        )
    ...
    def test_edit_data_karyawan_riwayat_sertifikasi(self):
        ...
        # test edit data
        patch_response = self.client.patch(
            reverse("data_karyawan_riwayat_sertifikasi", kwargs={"pk": 1}),
...
class CreatedataRiwayatJabatanFungsionalCase(SetupData):
    def test_create_data_karyawan_riwayat_jabatan_fungsional(self):
        response = self.client.post(
            reverse("data_karyawan_riwayat_jabatan_fungsional"),
    ...
    def test_edit_data_karyawan_riwayat_jabatan_fungsional(self):
        ...
        # test edit data
        patch_response = self.client.patch(
            reverse("data_karyawan_riwayat_jabatan_fungsional", kwargs={"pk": 1}),
            self.data_riwayat_jabatan_fungsional,
        )
        put_response = self.client.put(
            reverse("data_karyawan_riwayat_jabatan_fungsional", kwargs={"pk": 1}),
...
class CreatedataRiwayatKarirCase(SetupData):
    def test_create_data_karyawan_riwayat_karir(self):
        response = self.client.post(
            reverse("data_karyawan_riwayat_karir"), self.data_riwayat_karir
        )
    ...
    def test_edit_data_karyawan_riwayat_karir(self):
        ...
        # test edit data
        patch_response = self.client.patch(
            reverse("data_karyawan_riwayat_karir", kwargs={"pk": 1}),
