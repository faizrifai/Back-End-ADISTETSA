    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('NAMA_AUTHOR', models.CharField(max_length=255, validators=[adistetsa.custom_function.paksa_huruf_besar])),
            ],
        ),
        migrations.CreateModel(
            name='DonasiBuku',
        ...
        migrations.CreateModel(
            name='KatalogBuku',
            fields=[
                ('REGISTER', models.CharField(max_length=255, primary_key=True, serialize=False, validators=[adistetsa.custom_function.validasi_integer])),
                ('ISBN', models.CharField(blank=True, max_length=255, validators=[adistetsa.custom_function.validasi_integer])),
                ('JUDUL', models.CharField(max_length=255, validators=[adistetsa.custom_function.cek_huruf_besar_awal_kalimat])),
                ('VOLUME', models.CharField(blank=True, max_length=255, validators=[adistetsa.custom_function.validasi_integer])),
                ('EDISI', models.CharField(blank=True, max_length=255, validators=[adistetsa.custom_function.validasi_integer])),
                ('NOMER_DEWEY', models.CharField(max_length=255, validators=[adistetsa.custom_function.validasi_integer])),
                ('KODE_JUDUL', models.CharField(blank=True, max_length=255)),
                ('KOTA_PENERBIT', models.CharField(max_length=255, validators=[adistetsa.custom_function.cek_huruf_besar_awal_kalimat])),
                ('PENERBIT', models.CharField(max_length=255, validators=[adistetsa.custom_function.cek_huruf_besar_awal_kalimat])),
                ...
                ('HARGA', models.CharField(max_length=255, validators=[adistetsa.custom_function.validasi_integer])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('NAMA_MEDIA', models.CharField(max_length=255, validators=[adistetsa.custom_function.cek_huruf_besar_awal_kalimat])),
            ],
            options={
