# Generated by Django 4.0 on 2022-02-09 01:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('STATUS', models.CharField(choices=[('Sedang Dipinjam', 'Sedang Dipinjam'), ('Tenggat', 'Tenggat'), ('Pengajuan', 'Pengajuan'), ('Sudah Dikembalikan', 'Sudah Dikembalikan'), ('Hilang', 'Hilang')], default='Sudah Dikembalikan', max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='KunjunganGuru',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('JANGKA_PEMINJAMAN', models.CharField(blank=True, choices=[('Jangka Pendek', 'Jangka Pendek'), ('Jangka Panjang', 'Jangka Panjang')], max_length=255)),
                ('FILE_TTD_PENGAJUAN', models.FileField(blank=True, max_length=255, upload_to='Dokumen_Peminjaman_Jangka_Panjang_Guru')),
                ('STATUS_PEMINJAMAN', models.CharField(choices=[('Sedang Dipinjam', 'Sedang Dipinjam'), ('Tenggat', 'Tenggat'), ('Pengajuan', 'Pengajuan'), ('Sudah Dikembalikan', 'Sudah Dikembalikan'), ('Hilang', 'Hilang')], default='Sedang Dipinjam', max_length=255)),
            ],
        ),
        migrations.CreateModel(
