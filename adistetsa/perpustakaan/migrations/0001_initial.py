    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('STATUS', models.CharField(choices=[('Pengajuan', 'Pengajuan'), ('Sedang Dipinjam', 'Sedang Dipinjam'), ('Ditolak', 'Ditolak'), ('Hilang', 'Hilang'), ('Sudah Dikembalikan', 'Sudah Dikembalikan'), ('Tenggat', 'Tenggat')], default='Sudah Dikembalikan', max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='KunjunganGuru',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('JANGKA_PEMINJAMAN', models.CharField(blank=True, choices=[('Jangka Pendek', 'Jangka Pendek'), ('Jangka Panjang', 'Jangka Panjang')], max_length=255)),
                ('FILE_TTD_PENGAJUAN', models.FileField(blank=True, max_length=255, upload_to='Dokumen_Peminjaman_Jangka_Panjang_Guru')),
                ('STATUS_PEMINJAMAN', models.CharField(choices=[('Pengajuan', 'Pengajuan'), ('Sedang Dipinjam', 'Sedang Dipinjam'), ('Ditolak', 'Ditolak'), ('Hilang', 'Hilang'), ('Sudah Dikembalikan', 'Sudah Dikembalikan'), ('Tenggat', 'Tenggat')], default='Sedang Dipinjam', max_length=255)),
            ],
        ),
        migrations.CreateModel(
