...
import pandas
from .models import BahanBukuUPM, JenisBidang, PembagianTugasGuruBK, TugasPokokTendik, PembagianTugasPokokTambahanTendik, PembagianTugasGuruTIK, RincianTugasPokokTambahanTendik, TugasTambahanKepanitiaanTendik
...
admin.site.register(RincianTugasPokokTambahanTendik, RincianTugasPokokTambahanTendikAdmin)
