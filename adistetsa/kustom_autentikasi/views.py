...
from dataprofil.importexportresources import (
    DataGuruResource,
    DataSiswaResource,
    DataKaryawanResource,
    DataOrangTuaResource,
)
from dataprofil.models import DataSiswa, DataGuru, DataOrangTua, DataKaryawan
from dataprofil.serializers import (
    DataSiswaSerializer,
    DataGuruSerializer,
...
from .importexportresources import (
    DataSiswaUserResource,
    DataGuruUserResource,
    DataKaryawanUserResource,
)
from .models import *
...
class ProfilDetailView(APIView):
    ...
    @swagger_auto_schema(
        ...
        responses={
            "201": "Berhasil mengupdate profil",
            "400": "Bad Request",
        },
    )
...
class ImportDataSiswaView(APIView):
    ...
    @swagger_auto_schema(
        ...
        responses={
            "200": "Berhasil mengupdate data siswa",
            "400": "Gagal mengupdate data siswa, ada kesalahan",
        },
    )
    def post(self, request, format=None):
        ...
        try:
            result = data_siswa_resource.import_data(
            ...
            if not result.has_errors():
                ...
                return Response(
                    {"Result": "Berhasil mengupdate data siswa"}, status=200
                )
        except Exception as e:
            return Response({"Result": str(e)}, status=400)

        return Response(
            {"Result": "Gagal mengupdate data siswa, ada kesalahan"}, status=400
        )
...
class ExportDataSiswaView(APIView):
    ...
    def get(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {"Result": "Gagal mengexport data siswa, ada kesalahan"}, status=400
            )
...
class ImportDataGuruView(APIView):
    ...
    @swagger_auto_schema(
        ...
        responses={
            "200": "Berhasil mengupdate data guru",
            "400": "Gagal mengupdate data guru, ada kesalahan",
        },
    )
    def post(self, request, format=None):
        file = request.FILES["file"]
        ...
        try:
            result = data_guru_resource.import_data(
                csv_data, dry_run=True, raise_errors=True
            )
        ...
        return Response(
            {"Result": "Gagal mengupdate data guru, ada kesalahan"}, status=400
        )
...
class ExportDataGuruView(APIView):
    ...
    def get(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {"Result": "Gagal mengexport data guru, ada kesalahan"}, status=400
            )
...
class ImportDataKaryawanView(APIView):
    ...
    @swagger_auto_schema(
        ...
        responses={
            "200": "Berhasil mengupdate data karyawan",
            "400": "Gagal mengupdate data karyawan, ada kesalahan",
        },
    )
    def post(self, request, format=None):
        file = request.FILES["file"]
        ...
        try:
            result = data_karyawan_resource.import_data(
                csv_data, dry_run=True, raise_errors=True
            )
            ...
            if not result.has_errors():
                ...
                return Response(
                    {"Result": "Berhasil mengupdate data karyawan"}, status=200
                )
        except Exception as e:
            return Response(
                {"Result": "Gagal mengupdate data karyawan, ada kesalahan"}, status=400
            )
...
class ExportDataKaryawanView(APIView):
    ...
    def get(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {"Result": "Gagal mengexport data karyawan, ada kesalahan"}, status=400
            )
...
class ImportDataOrangTuaView(APIView):
    ...
    @swagger_auto_schema(
        ...
        responses={
            "200": "Berhasil mengupdate data orang tua",
            "400": "Gagal mengupdate data orang tua, ada kesalahan",
        },
    )
    def post(self, request, format=None):
        file = request.FILES["file"]
        ...
        try:
            result = data_orang_tua_resource.import_data(
                csv_data, dry_run=True, raise_errors=True
            )
            ...
            if not result.has_errors():
                ...
                return Response(
                    {"Result": "Berhasil mengupdate data orang tua"}, status=200
                )
        except Exception as e:
            return Response({"Result": str(e)}, status=400)

        return Response(
            {"Result": "Gagal mengupdate data orang tua, ada kesalahan"}, status=400
        )
...
class ExportDataOrangTuaView(APIView):
    ...
    def get(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {"Result": "Gagal mengexport data orang tua, ada kesalahan"}, status=400
            )
...
class ImportDataSiswaUserView(APIView):
    ...
    @swagger_auto_schema(
        ...
        responses={
            "200": "Berhasil membuat/ mengupdate data user siswa ",
            "400": "Gagal import data, ada kesalahan",
        },
    )
    def post(self, request, format=None):
        file = request.FILES["file"]
        ...
        try:
            result = data_siswa_user_resource.import_data(
                csv_data, dry_run=True, raise_errors=True
            )
            ...
            if not result.has_errors():
                ...
                return Response(
                    {"Result": "Berhasil menambahkan/ mengupdate data user siswa"},
                    status=200,
                )
        except Exception as e:
            return Response({"Result": str(e)}, status=400)
...
class ExportDataSiswaUserView(APIView):
    ...
    def get(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {"Result": "Gagal mengexport data user siswa, ada kesalahan"},
                status=400,
            )
...
class ImportDataGuruUserView(APIView):
    ...
    def post(self, request, format=None):
        ...
        try:
            result = data_guru_user_resource.import_data(
                csv_data, dry_run=True, raise_errors=True
            )
            ...
            if not result.has_errors():
                ...
                return Response(
                    {"Result": "Berhasil menambahkan/ mengupdate data user guru"},
                    status=200,
                )
        except Exception as e:
            return Response({"Result": str(e)}, status=400)
...
class ExportDataGuruUserView(APIView):
    ...
    def get(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {"Result": "Gagal mengexport data user guru, ada kesalahan"}, status=400
            )
...
class ImportDataKaryawanUserView(APIView):
    ...
    @swagger_auto_schema(
        ...
        responses={
            "200": "Berhasil membuat/ mengupdate data user karyawan",
            "400": "Gagal import data, ada kesalahan",
        },
    )
    def post(self, request, format=None):
        ...
        try:
            result = data_karyawan_user_resource.import_data(
                csv_data, dry_run=True, raise_errors=True
            )
            ...
            if not result.has_errors():
                ...
                return Response(
                    {"Result": "Berhasil menambahkan/ mengupdate data user karyawan"},
                    status=200,
                )
        except Exception as e:
            return Response({"Result": str(e)}, status=400)
...
class ExportDataKaryawanUserView(APIView):
    ...
    def get(self, request, format=None):
        ...
        try:
            ...
            return Response(
                {"Result": "Gagal mengexport data user karyawan, ada kesalahan"},
                status=400,
            )
