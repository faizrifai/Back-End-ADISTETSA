...
class DataSiswaUserResource(resources.ModelResource):
    ...
    def before_import_row(self, row, **kwargs):
        ...
        new_user = User.objects.get_or_create(
            username=username, password=password, email=data_siswa.EMAIL
        )
...
class DataGuruUserResource(resources.ModelResource):
    ...
    def before_import_row(self, row, **kwargs):
        ...
        username = (
            (data_guru.NAMA_LENGKAP + "_" + str(data_guru.TANGGAL_LAHIR.year))
            .lower()
            .replace(" ", "_")
        )
        password = row["password"]
...
class DataKaryawanUserResource(resources.ModelResource):
    ...
    def before_import_row(self, row, **kwargs):
        ...
        username = (
            (data_karyawan.NAMA_LENGKAP + "_" + str(data_karyawan.TANGGAL_LAHIR.year))
            .lower()
            .replace(" ", "_")
        )
        password = row["password"]
