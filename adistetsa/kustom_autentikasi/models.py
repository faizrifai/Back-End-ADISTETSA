...
from dataprofil.models import DataSiswa, DataOrangTua, DataGuru, DataKaryawan, DataPelatih
...
def post_save_data_pelatih(sender, instance, created, **kwargs):
    if created:
        try:
            ...
            user = User.objects.create(username=new_username, password=make_password('merdeka123'))
            user.save()
