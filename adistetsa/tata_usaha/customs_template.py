...
def data_buku_induk(self, obj1, obj2, obj3, obj4, obj5, obj6, obj7, obj8, obj9, obj10, obj11,obj12, obj13):
    ...
    ttl_cell.value = str(str(self.NIS.TEMPAT_LAHIR)+ ', '+ str(self.NIS.TANGGAL_LAHIR))
    ...
    alamat_cell.value = str(str(self.NIS.ALAMAT)+', RT = ' + str(self.NIS.RT)+ ' RW = ' + str(self.NIS.RW) + ', ' + str(self.NIS.DUSUN) + ', ' + str(self.NIS.KELURAHAN) + ', ' + str(self.NIS.KECAMATAN) + '. KODE POS (' + str(self.NIS.KODE_POS) + ')')
    ...
    tinggi_berat_cell.value = str(str(self.NIS.TINGGI_BADAN)+ '/' + str(self.NIS.BERAT_BADAN))
    ...
    tgl_ijazah_cell.value = str(str(self.TANGGAL_IJAZAH_S) + ' / ' + str(self.NO_IJAZAH_S))
    ...
    ttl_ayah_cell.value = str(str(self.ORANG_TUA.TEMPAT_LAHIR_AYAH)+ ', ' + str(self.ORANG_TUA.TAHUN_LAHIR_AYAH))
    ...
    ttl_ibu_cell.value = str(str(self.ORANG_TUA.TEMPAT_LAHIR_IBU)+ ', ' + str(self.ORANG_TUA.TAHUN_LAHIR_IBU))
    ...
    ttl_wali_cell.value = str(str(self.ORANG_TUA.TEMPAT_LAHIR_WALI)+ ', ' + str(self.ORANG_TUA.TAHUN_LAHIR_WALI))
    ...
    db.to_excel(writer, sheet_name='Beasiswa', index=False, )
    ...
    self.HASIL_EXPORT = ContentFile(virtual_workbook.getvalue(), str(self.NIS) + str(self.ID) + '.xlsx')
